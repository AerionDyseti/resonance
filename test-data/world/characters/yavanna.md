...
name: Yavanna
slug: yavanna
summary: "Yavanna (Quenya; IPA: - \"Giver of Fruits\") was of the Ainur and Valar, and one of the Aratar who was responsible for the growth of all the fruits and growing things of Arda. She was also called Kementári (Quenya; IPA: \"Queen of the Earth\"), Ivon (Sindarin; IPA: \"Giver of Fruits\"). She resided in the Pastures of Yavanna, in the south of Valinor., The First Age, The Elder Days, \"Valinor\" She was the wife of Aulë, older sister of Vána., Valaquenta, \"Of the Valar\""
properties:
  name: Yavanna
  othernames: Kementári, Palúrien
  title: Fruit-Giver,Queen of the Earth,Giver of Fruits,Queen of the Valar
  birth: Before the creation of Arda
  death: Immortal
  realms: Pastures of Yavanna
  spouse: Aulë
  race: Ainur (Valar)
  culture: Valier (Aratar)
  character: "}"
relationships:
  -
    type: part_of
...
## Etymology
In Quenya, ***Yavanna*** means "Giver of Fruits", from *yáve* ("fruit") and *anna* ("gift"). **Kementári**, her epithet, means "Queen of the Earth", from *kemen* ("the Earth") and *tari* ("Queen").

Her name in Sindarin is **Ivon**, meaning "Giver of Fruits". It is only attested in the compound *Ivonwin* ("Maidens of Yavanna"). The month *Ivanneth* may have been named after Yavanna.

### Earlier names
***Palúrien*** was an earlier name for Yavanna. It means "Lady of the Wide Earth."

## Maiar of Yavanna
-  Aiwendil (Radagast), who was sent as one of the *Istari* to help the Free People of Middle-earth against Sauron. However, he at least failed his mission, preferring to protect the flora and fauna of Middle-earth.
-  Melian is said to be kin to Yavanna, but wasn't considered a maiden of the "Queen of the Earth". She served instead both Vána, the sister of Yavanna, and Estë.

## Other versions
In other versions of the legendarium, Aulë and Yavanna were the parents of Oromë and Nessa and Lëa-vinya and Gwendeling were Maia of Yavanna. Furthermore, instead of Yavanna, in a few other versions, it was her sister Vána that made Laurelin bear its last fruit.
