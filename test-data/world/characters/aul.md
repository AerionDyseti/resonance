...
name: Aulë
slug: aul
summary: Aulë was a Vala and one of the Aratar, also known as the Smith and Smith of the Valar, concerned with rock, metal, nature of substances and works of craft.
properties:
  people: Vala
  name: Aulë
  pronun: (Q, )
  othernames: Aȝūlēz (V)Mahal (K)
  ...
  notablefor: creating the Dwarves
  spouse: Yavanna
  gender: Male
  steed: "}"
relationships:
...
## History
In the Song of the Ainur Aulë thought most of the fabric of the Earth.

When Ossë was also seduced by Melkor, Aulë pleaded with Uinen to calm and restrain him, and so the Maia returned to his master Ulmo.
...
When the Elves came to Valinor, the Noldor became the students of Aulë and his friends.

In the earlier *Etymologies*, the name apparently means "invention" in Quenya, from root GAWA.

## Other names
In Khuzdul, his name is ***Mahal*** ("The Maker").

Sometimes he was called ***Návatar***, probably meaning "Dwarf-father" in Quenya.

In earlier Noldorin, his name is ***Gaul***, usually called *Belegol* ("great Aulë") or *Barthan* ("World-artificer").

## Genealogy

## Other versions of the legendarium
In the early *Gnomish Lexicon*, the Gnomish version of *Aulë* is *Óli*. He is also given the title *Talka Marda* ("Smith of the World") during the text.
