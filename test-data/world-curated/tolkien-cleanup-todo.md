# Tolkien Cleanup TODO

## Language Systems

### Amtreadan (Elven)

Use for names with Elvish origins (Sindarin/Quenya). Characteristics:

- Agglutinative structure (compound words from root concepts)
- Uses diacritics: ë, ú, í, î, ô, á, é, ó, ä, ö
- Common suffixes: -ion, -iel, -wen, -dor, -lond, -ost, -rim, -roth
- Prefixes: A- (negation), U- (temporary), I-/O- (proximity/distance)
- See: `elven-vocab.md` and `elven-grammar.md`

### Ancient Human (Old English/Celtic)

Use for names with Mannish/Human origins. Characteristics:

- Old English/Norse/Celtic style
- Examples: Rohan → Aranada, Gondor → Argenthal
- Common patterns: -helm, -wyn, -gar, -hold, -land

### Dwarvish

Use for Dwarf-related names. Characteristics:

- Guttural consonants: kh, gh, zh
- Common elements: -dûm, -zâram, -zigil, -khâd
- Example: Khazad-dûm → Shadowdeep (translated)
...
| ------------- | ---------------- | ----- |
| Alalvinórë    | alalvin-r.md     |       |
| Avallónë      | avall-n.md       |       |
| Cuiviénen     | cuivi-nen.md     |       |
| Cár Abhainn   | c-r-abhainn.md   |       |
| Dor Dínen     | dor-d-nen.md     |       |
| Dor-Cúarthol  | dor-c-arthol.md  |       |
| Drúwaith Iaur | dr-waith-iaur.md |       |
| Híri          | h-ri.md          |       |
| Kalórmë       | kal-rm.md        |       |
| Nulukkizdîn   | nulukkizd-n.md   |       |
| Núrn          | n-rn.md          |       |
| Orod-na-Thôn  | orod-na-th-n.md  |       |
| Rôs           | r-s.md           |       |
| Sindanórië    | sindan-ri.md     |       |

## Locations (need Ancient Human - Mannish origin)

| Current Name   | File              | Notes |
| -------------- | ----------------- | ----- |
| Almaren        | almaren.md        |       |
| Angmar         | angmar.md         |       |
| Ard-galen      | ard-galen.md      |       |
| Armenelos      | armenelos.md      |       |
| Arvernien      | arvernien.md      |       |
| Avathar        | avathar.md        |       |
| Belegost       | belegost.md       |       |
| Brethil        | brethil.md        |       |
| Brithombar     | brithombar.md     |       |
| Dimbar         | dimbar.md         |       |
| Dor-lómin      | dor-l-min.md      |       |
| Dorthonion     | dorthonion.md     |       |
| Dunland        | dunland.md        |       |
| Edhellond      | edhellond.md      |       |
| Eglarest       | eglarest.md       |       |
| Enedwaith      | enedwaith.md      |       |
| Eregion        | eregion.md        |       |
| Eriador        | eriador.md        |       |
| Estolad        | estolad.md        |       |
| Falas          | falas.md          |       |
| Forodwaith     | forodwaith.md     |       |
| Gwathló        | gwathl.md         |       |
| Harad          | harad.md          |       |
| Hildórien      | hild-rien.md      |       |
| Himlad         | himlad.md         |       |
| Hithlum        | hithlum.md        |       |
| Khand          | khand.md          |       |
| Kortirion      | kortirion.md      |       |
| Ladros         | ladros.md         |       |
| Lammoth        | lammoth.md        |       |
| Linhir         | linhir.md         |       |
| Lond Daer      | lond-daer.md      |       |
| Losgar         | losgar.md         |       |
| Lothlann       | lothlann.md       |       |
| Maglor         | maglors-gap.md    |       |
| Menegroth      | menegroth.md      |       |
| Meneltarma     | meneltarma.md     |       |
| Mithrim        | mithrim.md        |       |
| Mount Dolmed   | mount-dolmed.md   |       |
| Mount Gram     | mount-gram.md     |       |
| Mount Gundabad | mount-gundabad.md |       |
| Neldoreth      | neldoreth.md      |       |
| Nevrast        | nevrast.md        |       |
| Nogrod         | nogrod.md         |       |
| Ossiriand      | ossiriand.md      |       |
| Ost-in-Edhil   | ost-in-edhil.md   |       |
| Palisor        | palisor.md        |       |
| Pelargir       | pelargir.md       |       |
| Rhûn           | rh-n.md           |       |
| Thangorodrim   | thangorodrim.md   |       |
| Tharbad        | tharbad.md        |       |
| Thargelion     | thargelion.md     |       |
| Umbar          | umbar.md          |       |
| Írensaga       | rensaga.md        |       |

## Characters (VALAR/MAIAR - Deities)
...
| Amras                | amras.md                |       |
| Amrod                | amrod.md                |       |
| Ancalagon            | ancalagon.md            |       |
| Andróg               | andr-g.md               |       |
| Angrod               | angrod.md               |       |
| Aredhel              | aredhel.md              |       |
| Beleg                | beleg.md                |       |
| Bór                  | b-r.md                  |       |
| Caranthir            | caranthir.md            |       |
| Celegorm             | celegorm.md             |       |
| Curufin              | curufin.md              |       |
| Daeron               | daeron.md               |       |
| Dior                 | dior.md                 |       |
| Ecthelion            | ecthelion.md            |       |
| Egalmoth             | egalmoth.md             |       |
| Elros                | elros.md                |       |
| Elwing               | elwing.md               |       |
| Eärendur of Arnor    | e-rendur-of-arnor.md    |       |
| Eärendur of Oldshore | e-rendur-of-oldshore.md |       |
| Eärwen               | e-rwen.md               |       |
| Finduilas            | finduilas.md            |       |
| Fingon               | fingon.md               |       |
| Glaurung             | glaurung.md             |       |
| Glóredhel            | gl-redhel.md            |       |
| Gwindor              | gwindor.md              |       |
| Idril                | idril.md                |       |
| Mablung              | mablung.md              |       |
| Maedhros             | maedhros.md             |       |
| Maeglin              | maeglin.md              |       |
| Maglor               | maglor.md               |       |
| Orodreth             | orodreth.md             |       |
| Roäc                 | ro-c.md                 |       |
| Saeros               | saeros.md               |       |
| Tar-Aldorion         | tar-aldorion.md         |       |
| Tar-Ancalimon        | tar-ancalimon.md        |       |
| Tar-Atanamir         | tar-atanamir.md         |       |
| Tar-Ciryatan         | tar-ciryatan.md         |       |
| Tar-Minastir         | tar-minastir.md         |       |
| Tar-Seeing-Stone     | tar-seeing-stone.md     |       |
| Thingol              | thingol.md              |       |
| Tuor                 | tuor.md                 |       |
| Turgon               | turgon.md               |       |
| Éadgifu              | adgifu.md               |       |
...
## Characters (need Dwarvish replacement)

| Current Name | File         | Notes |
| ------------ | ------------ | ----- |
| Gimilkhâd    | gimilkh-d.md |       |

## Organizations (need Amtreadan)

| Current Name | File    | Notes |
| ------------ | ------- | ----- |
| Éoherë       | oher.md |       |

## Organizations (need Ancient Human)

| Current Name | File    | Notes |
| ------------ | ------- | ----- |
| Éored        | ored.md |       |

## Already Mapped (in curated-mappings.json)

These names have mappings but may still appear in files with old names.
| Current Name | File | Category |
|--------------|------|----------|
| Alqualondë | alqualond.md | locations |
| Annúminas | ann-minas.md | locations |
| Araman | araman.md | locations |
| Beren | beren.md | characters |
| Helcaraxë | helcarax.md | locations |
| Rómenna | r-menna.md | locations |
| Zirakzigil | zirakzigil.md | locations |
| Éomer | horsehelm.md | characters |
| Éowyn | shieldwyn.md | characters |
