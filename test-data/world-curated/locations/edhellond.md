...
name: Edhellond
slug: edhellond
summary: Edhellond was an ancient harbour in southern Argenthal. It had been established south-west of where the Ringló entered the Morthond, near where the combined waters flowed into Cobas Haven., West, p.
properties:
  name: Edhellond
  othernames: "Amroth's Haven"
  location: Southern Argenthal, confluence of the Ringló and Morthond rivers
  type: Harbour
  description: A far southern haven of the Amtreadi
  inhabitants: Founded by Liinadi, later joined by many Liinadi Amtreadi
...
:Although Edhellond itself is abandoned, a small group of Amtreadi, the "Avorrim" still live in nearby caves in secret, known only to the ruling line of Swan Keep. They maintain a watch over Edhellond as, should the unthinkable happen and the access to the Mistport be lost, it would remain the only place in Middle-Earth from which the Amtreadi could sail into the West. During the War of the Binding the Corsairs of Umbar who blockade Swan Keep dock many of their ships in Edhellond, which becomes one of their staging areas.
