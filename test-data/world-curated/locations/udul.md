...
name: Udul
slug: udul
summary: Udul was the name of a village that threatened the town of Agar with marauders during the Second Era.
properties:
  name: Udul
  location: Far inland from Agar
  type: Village
  description: Small settlement populated with sick folk
  inhabitants: Udul-folk
  events: "}"
relationships:
  -
    type: located_in
    target: loc-far-inland-from-agar
---

# Udul

**Udul** was the name of a village that threatened the town of Agar with marauders during the Second Era.
